<template>
  <div>
          ...
          <ul class="shop_list" v-if="shopsList.length>0">
            <li class="shop_li border-1px" v-for="(item,index) in shopsList" :key="index" @click="$router.push('/shop')">
              <a >
                <div class="shop_left">
...
mounted(){
   this.$store.dispatch('asyncGetShop', this)
}
}
</script>
